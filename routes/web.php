...
Route::get("/list-user", [UserManageController::class, 'UserList'])->middleware([TokenVerificationMiddleware::class]);
Route::post("/create-user", [UserManageController::class, 'UserCreate'])->middleware([TokenVerificationMiddleware::class]);
Route::post("/user-by-id", [UserManageController::class, 'UserByID'])->middleware([TokenVerificationMiddleware::class]);

Route::post('/user-edit-data', [UserManageController::class, 'EditUserData'])->middleware([TokenVerificationMiddleware::class]);


Route::post("/delete-user", [UserManageController::class, 'UserDelete'])->middleware([TokenVerificationMiddleware::class]);
...
Route::get('/allUsers', [UserManageController::class, 'AllUser'])->middleware([TokenVerificationMiddleware::class]);
